...
import { X, Plus, Edit2, Trash2, Calendar, Clock } from 'lucide-react';
...
export const DayView: React.FC<DayViewProps> = ({ date, programs, allPrograms, onClose, onProgramsChange }) => {
    ...
    const handleEditProgram = (program: ServiceProgram) => {
        // TODO: Open program editor modal
    ...
    return (
        <div className="h-full flex flex-col bg-white">
            ...
            {/* Drop Zone & Services List */}
            <div
                ref={drop}
                className={`flex-1 overflow-y-auto p-4 ${isOver && canDrop ? 'bg-blue-50 border-2 border-dashed border-blue-400' : ''
                    }`}
            >
                {programs.length === 0 ? (
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span
                                                className={`px-2 py-0.5 rounded-full text-xs font-medium ${program.status === 'confirmed'
